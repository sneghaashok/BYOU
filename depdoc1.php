...
.forma{
 ...
 $link = mysqli_connect("localhost", "root", "", "byou2");
        ...
        if(isset($_POST['reqbtn'])){
            ...
            $message = $_POST['msg'];
             $querys = "SELECT * FROM patdocs WHERE dname='priyanka' AND pname='$pname'  LIMIT 1";
             $query2="SELECT * FROM requests WHERE dname='priyanka' AND pname='$pname'  LIMIT 1";
