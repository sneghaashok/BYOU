...
<div class="collapse navbar-collapse navbar-right navbar-main-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="#intro">Your Appointments</a></li>
            <li><a href="index_patient.php?logout='1'">Logout</a></li>
 ...
 <section class="docs">
  ...
  <div class="rev_box1">
               ...
               <img style="width: 220px; height: 220px;" src="img/doctors/da1.jpg">
                </div>
                <div class="rev_cntnt">
                <p class="rev_title">Dr. Jamuna Kakarla</p>
                <p class="rev_cap">(Masters in Applied Psychology)</p>
                 <p class="rev_cap">(Counsellor)</p>
                </div>
                <div class="btn_s_bottom">
                <a href="anxietydoc.php">
  ...
  <div class="rev_box1">
                ...
                <img style="width: 220px; height: 220px;" src="img/doctors/da3.jfif">
                </div>
                <div class="rev_cntnt">
                <p class="rev_title">Counsellor Liza</p>
                <p class="rev_cap">(Masters in Clinical Psychology)</p>
                 <p class="rev_cap">(Therapist)</p>
              </div>
                <div class="btn_s_bottom">
                <a href="anxietydoc2.php">
                    <button class="butn" style="margin-top:20px; background: #3FBBC0;color: #fff;border-radius: 30px;font-size: 16px; padding: 10px;">More About Her</button>
                  </a>
                </div>
              </div>
  ...
  <div class="rev_box1">
                ...
                <img style="width: 220px; height: 220px;" src="img/doctors/da2.jpg">
                </div>
                <div class="rev_cntnt">
                <p class="rev_title">Counsellor Yukti</p>
                <p class="rev_cap">(Masters in Counselling Psychology)</p>
                 <p class="rev_cap">(Counsellor)</p>
             </div>
                 <div class="btn_s_bottom">
                </a><a href="anxietydoc3.php">
                    <button class="butn" style="margin-top:20px; background: #3FBBC0;color: #fff;border-radius: 30px;font-size: 16px; padding: 10px;">More About Her</button>
                  </a>
                </div>
              </div>
