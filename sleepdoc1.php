...
if(isset($_POST['reqbtn'])){
	...
	$message = $_POST['msg'];
	$querys = "SELECT * FROM patdocs WHERE dname='anitha' AND pname='$pname'  LIMIT 1";
	$query3 = "SELECT * FROM patdocs WHERE pname='$pname'  LIMIT 1";
	$query2="SELECT * FROM requests WHERE dname='anitha' AND pname='$pname'  LIMIT 1";
	...
	{
		$query = "INSERT INTO `requests` (`id`, `pname`, `dname`, `message`) VALUES ('$userid', '$pname', 'anitha', '$message' )";
    		...
    		<nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
    			...
    			<section id="about" class="home-section bg-gray paddingbot-5">
    				...
    				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 profile-txt" style="text-align: center; font-size: 22px;">
    					<p class="quote_p"><span class="quote"><i class="fa fa-quote-left qtc"></i> Most of our suspicions of others are aroused by our knowledge of ourselves.<i class="fa fa-quote-right qtc"></i></span></p>
    				</div>
    				<div class="sideh">
    					<h4>Approach:</h4>
    				</div>
