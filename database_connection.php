...
function fetch_user_chat_history($from_user_id, $to_user_id, $connect)
{
	...
	foreach($result as $row)
	{
		...
		else
		{
			...
			$dynamic_background = 'background-color:#f5f2f0;';
		}
		$output .= '
		<li style=" font-family: Open Sans, sans-serif;  font-size: 15px;border-bottom:2px dotted #ccc;padding-top:8px; padding-left:8px; padding-right:8px;'.$dynamic_background.'">
