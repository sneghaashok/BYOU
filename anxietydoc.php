...
.forma{
 ...
 $link = mysqli_connect("localhost", "root", "", "byou2");
        ...
        if(isset($_POST['reqbtn'])){
            ...
            $message = $_POST['msg'];
             $querys = "SELECT * FROM patdocs WHERE dname='jamuna' AND pname='$pname'  LIMIT 1";
             $query2="SELECT * FROM requests WHERE dname='jamuna' AND pname='$pname'  LIMIT 1";
...
$results3 = mysqli_query($link, $query3);
                 ...
                 $num_rows2=mysqli_num_rows($result2);
                  ...
                  {
                     $query = "INSERT INTO `requests` (`id`, `pname`, `dname`, `message`) VALUES ('$userid', '$pname', 'jamuna', '$message' )";
...
<div class="collapse navbar-collapse navbar-right navbar-main-collapse">
  ...
  <section id="about" class="home-section bg-gray paddingbot-5">
  	<div class="section-heading text-center">
                <h2 >Dr. Jamuna Kakarla</h2>
              </div>
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 profile-txt" style="text-align: center; font-size: 22px;">
            <p class="quote_p"><span class="quote"><i class="fa fa-quote-left qtc"></i>The will to do something is what can turn around our lives.<i class="fa fa-quote-right qtc"></i></span></p>
          </div>
    <div class="sideh">
      <h4>Approach:</h4>
    </div>
    <div class="sidep">
    I predominantly use Solution focused approach, positive psychotherapy, Cognitive Behavioural therapy, and person-centered approaches.</div>
    <div class="sideh">
      <h4>Her Thoughts on Counseling:</h4>
    </div>
    <div class="sidep">
    Counseling not only helps in dealing with anxiety, but it changes the way you view anxiety inducing factors and the approach towards them.</div>
    <div class="sideh">
      <h4>Why I choose Counseling?</h4>
    </div>
    <div class="sidep">
   While I was growing up, my father was diagnosed with Depression, and after seeing him struggle with it, we decided to meet a clinical psychologist. Slowly the treatment and therapy began and with time I saw a change in my father. The therapist used to counsel to everyone in the family on how to deal this phase and enhance familial bond so that he feels better.<br>
  From a quiet and negative person, my father changed into positive man and it was all because of that therapist. This really inspired me to take up this field, as I experienced the change it can bring in a person's & their family's life.</div>
  <div class="sideh">
      <h4>Therapy Style:</h4>
    </div>
    <div class="sidep">
   My favorite therapy is Rational Emotive Behavioral Therapy. The reason that I love this therapy is because many a times, it is a string of irrational thoughts that comes together and causes stress.<br>
  REBT helps build awareness of these stress inducing irrational thinking patterns and helps a client understand how to change them.</div>
...
<center>  <button name="reqbtn" type="submit" class="agileinfo">Send Request</button></center>
 </form>
</section>
