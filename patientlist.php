        ...
        <div class="container">
            <?php
              $username=$_SESSION['username'];
                $query = "SELECT pname FROM patdocs where dname='$username';";
                if(count(fetchAll($query))>0){
                    ...
                    <h4 class="jumbotron-heading"><?php echo $row['pname'] ?></h4>
                      <p>
                        ...
                        <a href="chat_index.php" class="butn">Chat</a>
                        <a href="deletepatient.php?pname=<?php echo $row['pname'] ?>" class="butn">Delete Patient</a>
                      </p>
                <?php
                    }
                }else{
                    echo "No Patients, Thank You.";
                }
            ?>
        </div>
      </section>
