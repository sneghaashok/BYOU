...
if (isset($_POST['add_doc'])) {
  ...
  if (count($errors) == 0) {
    ...
    $query = "INSERT INTO login ( `Name`, `username`, `email`, `dob`, `gender`, `mobile`, `password`, `usertype`, `department`) VALUES ('$fname','$username', '$email', '$dob', '$gender','$mnumber','$password_1','doctor','$department')";
